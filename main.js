...
class UI {
  ...
  static openReminders() {
    _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].updateReminders();
  ...
  static addTask() {
    ...
    const taskDate =
      addTaskDate.value === ""
        ? ""
        : (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(addTaskDate.value), "dd/MM/yyyy");

    if (addTaskDate.value !== "") {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(addTaskDate.value), new Date())) {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].addTask(
      projectName,
      new _Task__WEBPACK_IMPORTED_MODULE_2__["default"](taskTitle, taskName, taskDate, taskColor, taskisDone)
    );
  ...
  static setTaskCompleted(taskButton) {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskCompletion(projectName, taskName, true);
    _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].updateReminders();
    UI.clearTasks();
    UI.loadTasks(projectName);
  }
  ...
  static setTaskDate() {
    ...
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(this.value), new Date())) {
      alert("Date is already in the past.");
      dueDateInput.value = "";
      return;
    }
  ...
  static setTaskColor() {
    ...
    _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskColor(projectName, taskName, newColor);
    _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].updateReminders();
    UI.clearTasks();
    UI.loadTasks(projectName);
